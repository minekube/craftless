...
The active product-completion sequence is tracked outside this file. Use:

- `docs/superpowers/phase-index.md` for the maintained phase index and
  phase-history notes;
- `docs/project-completion-checklist.md` for status, verification evidence,
  blockers, and completion gates;
- `docs/superpowers/specs/` and `docs/superpowers/plans/` for the
  authoritative design and implementation documents for each phase.
