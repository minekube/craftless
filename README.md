...
| Latest and older lanes | Representative older `1.20.6` packaged attach is verified; `latest-release` currently resolves to `26.2` and fails early because no packaged 26.x driver lane exists |
